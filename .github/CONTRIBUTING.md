...
* Create an [issue](https://github.com/jonnitto/Jonnitto.NodeTypes/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Jonnitto.NodeTypes/issues), assuming one does not already exist.
